...
const Footer = () => {
  return (
    <footer className="bg-gray-100">
          ...
          <div className="mr-10">
            ...
            <div className="text-gray-700">
              ...
              <p className="mt-4">
                ...
                <a href="tel:0867677891" className="text-blue-600">
                  0867677891
                </a>
              </p>
              <p className="mt-2">
                <span className="font-bold">Email:</span>{" "}
                <a href="mailto:contact@paddy.vn" className="text-blue-600">
                  contact@paddy.vn
                </a>
              </p>
            </div>
      ...
      <div className="bg-white py-6 flex justify-between items-center">
